...
module YetiThriftTest
  ...
  class UnionOfStructs < ::Thrift::Union
    ...
    FIELDS = {
      NUM => {:type => ::Thrift::Types::STRUCT, :name => 'num', :class => ::YetiThriftTest::AllBaseStruct},
      STR => {:type => ::Thrift::Types::STRUCT, :name => 'str', :class => ::YetiThriftTest::AllBaseStruct}
    }
  ...
  class EventUnion < ::Thrift::Union
    ...
    FIELDS = {
      ...
      HAPPENED => {:type => ::Thrift::Types::I64, :name => 'happened'}
    }
  ...
  class UnionWithListOfStructs < ::Thrift::Union
    ...
    FIELDS = {
      STRUCTS => {:type => ::Thrift::Types::LIST, :name => 'structs', :element => {:type => ::Thrift::Types::STRUCT, :class => ::YetiThriftTest::EmbeddedStruct}},
      OTHER => {:type => ::Thrift::Types::STRING, :name => 'other'}
    }
  ...
  class TrueOrFalse < ::Thrift::Union
    ...
    FIELDS = {
      T_OR_F => {:type => ::Thrift::Types::STRING, :name => 't_or_f'},
      B => {:type => ::Thrift::Types::BOOL, :name => 'b'},
      ONE_OR_ZERO => {:type => ::Thrift::Types::I16, :name => 'one_or_zero'}
    }
